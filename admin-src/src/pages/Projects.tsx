...
export default function Projects() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      if (editing) {
        await put(`/portfolio/projects/${editing}`, form);
        setSuccess("Projet modifie.");
      } else {
        await post("/portfolio/projects", form);
            ...
            <div className="form-grid">
              ...
              <div className="form-group">
                ...
                <div className="form-check">
                  ...
                  />
                  <label htmlFor="proj-pub">Publie</label>
                </div>
              </div>
              <div className="form-group">
                <label>&nbsp;</label>
          ...
          <tbody>
            ...
            {items.map((item) => (
              <tr key={item.id}>
                ...
                <td>
                  <span className={`badge ${item.featured ? "badge-on" : "badge-off"}`}>
